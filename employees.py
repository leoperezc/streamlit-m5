...
# Funciones para ejecutar los filtros
...
# Filtros utilizando cajas de texto y botones.
...
# Instrucciones para filtro por Hometown.
...
# Instrucciones para filtro por Unit.
...
#Filtros utilizando el control Selectbox
...
if nivel_educativo_seleccionado:
...
st.subheader('Diagrama de frecuencias Cantidad de Empleados por Unidad')
st.pyplot(fig2)
